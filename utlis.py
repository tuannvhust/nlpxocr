...
def get_args():
    ...
    #prepare_data
    parser.add_argument("--test_file",type=str,default="data/vi.test.txt")
    parser.add_argument("--metadata",type=str,default="metadata.json")
    parser.add_argument("--metadata_bartpho",type=str,default="metadata2.json")
    ...
    #train
    parser.add_argument("--embedding_model",type=str,default='attention')
    ...
    parser.add_argument("--cnn_kernel",type=str,default='1,1,1,1,1')
